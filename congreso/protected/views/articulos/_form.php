...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'id_evento',array('style'=>'display: none;')); ?>
		<?php echo $form->textField($model,'id_evento',array('class'=>'form-control','value'=>1,'style'=>'display: none;')); ?>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'aceptado'); ?>
		<?php echo $form->textField($model,'aceptado',array('class'=>'form-control','disabled'=>'false')); ?>
		<?php echo $form->error($model,'aceptado'); ?>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'resultado'); ?>
		<?php echo $form->textArea($model,'resultado',array('rows'=>6, 'cols'=>50,'class'=>'form-control','disabled'=>'false')); ?>
		<?php echo $form->error($model,'resultado'); ?>
	</div>
